      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <div className="bg-white justify-center">
          ...
          <div className="flex justify-center py-6">
            <img className="h-205 w-206 justify-center rounded-lg" src="/logo.svg" ></img>
          </div>
          {/* Username */}
          <div className="p-2">
          ...
          <div className="p-2">
            ...
            <p className="text-right text-[#D84A05] font-bold text-xs ">Forgot Password</p>
          </div>
          {/* tombol login */}
          <div>
            <div className="py-2">
          ...
          <div className="flex flex-row justify-center py-2">
            <p className="text-[12px]">Doesn't have an account? <a href="signup" className="text-bold text-[12px] font-bold">SIGN UP</a>
            </p>
          </div>
        </div>
      </main>
