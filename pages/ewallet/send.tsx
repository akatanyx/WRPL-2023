...
export default function send () {
    return (
        <div className="font-poppins pl-[35px] md:mx-auto md:ml-0">
            ...
            <p className="text-[14px]">Masukkan nomor tujuan</p>

            <div className="flex mt-[25px]">
                <img src="/e_send_telepon.svg" />
                <h1 className="text-[20px] text-[#263238] ml-2">+62</h1>
                ...
                <InputMask
                    ...
                    className="ml-[5px] text-[#263238] text-[20px] caret-transparent focus:outline-none"
                    onChange={(e: any) => {
